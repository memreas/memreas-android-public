...
public class RoundedCornerImageView extends ImageView {
	...
	public RoundedCornerImageView(Context context, AttributeSet attrs,
		...
		int index = a.getInt(
				R.styleable.RoundedCornerImageView_android_scaleType, -1);
		if (index >= 0) {
			setScaleType(sScaleTypeArray[index]);
		}

		mCornerRadius = a.getDimensionPixelSize(
				R.styleable.RoundedCornerImageView_corner_radius, -1);
		...
		mBorderColor = a
				.getColorStateList(R.styleable.RoundedCornerImageView_border_color);
		...
		mRoundBackground = a.getBoolean(
				R.styleable.RoundedCornerImageView_round_background, false);
		mOval = a.getBoolean(R.styleable.RoundedCornerImageView_is_oval, false);
